---
title: "SI prediction using Detected Difference"
author: "Aditya"
date: "24 May 2018"
...
save_path <- "C:/aditya/Thermal_images/Final_models/New patients/Final_models/Detection/"  

source(paste0(func_path ,"fun_binary_shock_ind.R"))
source(paste0(func_path ,"cp_max_thrsh.R"))

#################### Data ###################
for_modeling_diff_with_30min  <- read.csv(paste0(data_path,                 "for_modeling_with_dete_diff_sm_time.csv"))

for_modeling_diff_with_3hr  <-read.csv(paste0(data_path,
                                        "for_modeling_with_dete_diff_3hr.csv"))

for_modeling_diff_with_6hr  <- read.csv(paste0(data_path,
"for_modeling_with_dete_diff_6hr.csv"))


for_modeling_diff_with_12hr  <- read.csv(paste0(data_path, "for_modeling_with_dete_diff_12hr.csv"))
...
sum(is.na(data_for_mod_post30minshock$Median_PR))
...
tr_set_sm_tm <- data.frame(data_for_mod_post30minshock[which(data_for_mod_post30minshock$UHID %in% tr_uhid),])
  ...
  fit_glmer_30min <- glmer(binary_SI_Sm_Tm ~   
                           dete_diff_percent+Rescaled_Median_PR+age_mo+(1|UHID),
                           data = tr_set_sm_tm, 
                           family = binomial,
  ...
  par(mar=c(9,6,6,6))
  plot(perf_glmer,colorize =T, main=paste('ROC', 'Shock ind same time, AUC=', round(AUC_glmer,2),sep = ' '), cex.lab=1.5, cex.axis=2, cex.main=1.5, cex.sub=2)  
...
for(i in 1:10){
  ...
  AUC_glmer= round((performance(pred_glmer_perf, "auc")@y.values[[1]]),2)
  par(mar=c(8,5,5,5))
  plot(perf_glmer,colorize =T, main=paste('ROC', 'Shock ind 3hr, AUC=', round(AUC_glmer,2),sep = ' '),cex.lab=1.5, cex.axis=2, cex.main=1.5, cex.sub=2) 
...
performance3hr  <- cbind((ten_fold_auc[,1]),
                          (ten_fold_accuracy[,1]),
                          (ten_fold_byclass[,1]),
                          (ten_fold_byclass[,2]),
                          (ten_fold_byclass[,3]),
...
for(i in 1:10){
  ...
  AUC_glmer= round((performance(pred_glmer_perf, "auc")@y.values[[1]]),2)
  par(mar=c(8,5,5,5))
  plot(perf_glmer,colorize =T, main=paste('ROC', 'Shock ind at 6hr, AUC=', round(AUC_glmer,2),sep = ' '),cex.lab=1.5, cex.axis=2, cex.main=1.5, cex.sub=2) 
...
glmer_models_sum[3,] <- c(coefficients_glmer_6hr,
                          ...
                          sd(ten_fold_byclass[,2]),
                          mean(ten_fold_cutoff[,1]))
performance6hr  <- cbind( (ten_fold_auc[,1]),
                          (ten_fold_accuracy[,1]),
                          (ten_fold_byclass[,1]),
                          (ten_fold_byclass[,2]),
                          (ten_fold_byclass[,3]),
...
for(i in 1:10){
  ...
  AUC_glmer= round((performance(pred_glmer_perf, "auc")@y.values[[1]]),2)
  par(mar=c(8,5,5,5))
  plot(perf_glmer,colorize =T, main=paste('ROC', 'Shock ind at 12hr, AUC=', round(AUC_glmer,2),sep = ' '), cex.lab=1.5, cex.axis=2, cex.main=1.5, cex.sub=2) 
...
performance12hr  <- cbind((ten_fold_auc[,1]),
                          (ten_fold_accuracy[,1]),
                          (ten_fold_byclass[,1]),
                          (ten_fold_byclass[,2]),
                          (ten_fold_byclass[,3]),
...
acc_disc <- rbind(performance_sm_tm, performance3hr, performance6hr, performance12hr)
View(acc_disc)
...
########### Boxplots ##########
# acc_disc  <- data.frame(acc_disc) 
# write.csv(acc_disc, "C:/aditya/Thermal_images/Final_models/Paper_figures/acc_disc_dete.csv", row.names= F)
